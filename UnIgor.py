...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.title_lable.setGeometry(QtCore.QRect(260, 0, 271, 31))
        self.title_lable.setObjectName("title_lable")
        self.horizontalLayoutWidget = QtWidgets.QWidget(self.centralwidget)
        self.horizontalLayoutWidget.setGeometry(QtCore.QRect(10, 40, 801, 61))
        ...
        self.start_button.setGeometry(QtCore.QRect(30, 120, 121, 41))
        self.start_button.setObjectName("start_button")
        self.status_label = QtWidgets.QLabel(self.centralwidget)
        self.status_label.setGeometry(QtCore.QRect(166, 120, 631, 41))
        ...
        self.action_NC = QtWidgets.QAction(MainWindow)
        self.action_NC.setObjectName("action_NC")
        self.menu.addAction(self.action_NC)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.action_NC.setText(_translate("MainWindow", "Настройка пути с *.NC"))
