...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.start_button.setGeometry(QtCore.QRect(10, 170, 121, 41))
        self.start_button.setObjectName("start_button")
        self.status_label = QtWidgets.QLabel(self.centralwidget)
        self.status_label.setGeometry(QtCore.QRect(150, 170, 771, 41))
        self.status_label.setText("")
        self.status_label.setObjectName("status_label")
        self.label = QtWidgets.QLabel(self.centralwidget)
        self.label.setGeometry(QtCore.QRect(70, 0, 791, 51))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label.setText(_translate("MainWindow", "Программа для сборки *.NC файлов. Постпроцессоры: Bumotec S191v2.1, Macodell S7v.2"))
